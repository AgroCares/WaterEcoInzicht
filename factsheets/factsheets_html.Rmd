...
```{r licht2, echo= FALSE, warning = FALSE, message = FALSE, fig.cap= "Lichtklimaat in plassen obv extinctie of Waterdiepte en doorzicht in sloten."}
...
```{r watbaltable, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", results='asis'}
