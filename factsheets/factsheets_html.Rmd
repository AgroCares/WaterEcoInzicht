...
Deze factsheet is gebaseerd op de KRW-toetsing (aan maatlatten 2018) uit `r out$toetsjaar`, begrenzing waterlichamen 2022-2027, hydrobiologische data `r out$hybitotaalversie`, conceptmaatregelen en doelen voor SGBP3 `r if(!is.na(out$waterlichamenwl$Literatuurverwijzing)|!out$waterlichamenwl$Literatuurverwijzing == ''){paste0(" en ",out$waterlichamenwl$Literatuurverwijzing)}`.
...
```{r chartP, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = 'Fosforbelasting per bron (bar) en kritische belasting.'}
...
```{r licht2, echo= FALSE, warning = FALSE, message = FALSE, fig.cap= "Lichtklimaat in plassen obv extinctie of Waterdiepte in sloten."}
...
### Brondata: Water- en stoffenbalansen (balans t/m `r out$pvskpversie`)
