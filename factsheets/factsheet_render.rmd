...
waterpereag <- sf::st_read(paste0('./input/',workspace, '/gebiedsinfo/WaterPerEAG20191205.gpkg'),quiet = T) %>% sf::st_transform(28992)
# shape met waterschapsgebied
waterschappen  <- sf::st_read(paste0('./input/',workspace, '/gebiedsinfo/2019_gemeentegrenzen_kustlijn_simplified.shp'),quiet = T) %>%sf::st_transform(28992)
